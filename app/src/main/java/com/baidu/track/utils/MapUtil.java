...
import static com.baidu.track.utils.Constants.TAG;
...
public class MapUtil {
    ...
    public void drawHistoryTrack(List<LatLng> points, boolean staticLine, float direction) {
        // 绘制新覆盖物前，清空之前的覆盖物
        try {
            Log.e(TAG, "drqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq" );
            baiduMap.clear();
            ...
            LatLng endPoint1 = points.get(points.size() - 2);
            LatLng endPoint2 = points.get(points.size() - 3);
            // 添加起点图标
            ...
            if (staticLine) {
                ...
                drawEndPoint(endPoint1);
                drawEndPoint(endPoint2);
            }
